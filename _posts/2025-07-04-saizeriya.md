...
です。言葉で言われてもよくわからないですよね。~~僕もよくわからない~~<br>
...
以下がグランドメニューをスクレイピングするコードになります。データ形式はcsvでファイル名は saizeriya_menu.csv としています。
``` py
import requests
import pandas as pd
...
\- ライス | 150円 | 303kcal<br>
\- ターメリックライス | 200円 | 424kcal<br>
\- ペペロンチーノ | 300円 | 582kcal<br>
\- 焼チーズ ミラノ風ドリア | 350円 | 666kcal<br>
